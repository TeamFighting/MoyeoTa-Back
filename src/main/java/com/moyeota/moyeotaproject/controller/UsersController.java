...
public class UsersController {
    ...
    @PutMapping("/info")
    public ResponseDto<UsersResponseDto> updateInfo(@RequestHeader(value = "Authorization") String tokenInfo, @RequestBody UserDto.updateDto usersDto) {
    ...
    public ResponseDto<String> schoolEmail(@RequestHeader(value = "Authorization") String tokenInfo, @RequestBody SchoolDto.RequestForUnivCode schoolRequestDto) throws IOException {
    ...
    public ResponseDto<SchoolDto.ResponseSuccess> schoolEmailCheck(@RequestHeader(value = "Authorization") String tokenInfo, @RequestBody SchoolDto.RequestForUnivCodeCheck schoolRequestDto) throws IOException {
    ...
    public ResponseDto<UsersResponseDto> createNickName(@RequestHeader(value = "Authorization") String tokenInfo, @RequestBody UserDto.updateNickName usersDto) {
    ...
    @PutMapping("/nickname")
    public ResponseDto<UsersResponseDto> updateNickname(@RequestHeader(value = "Authorization") String tokenInfo, @RequestBody UserDto.updateNickName usersDto) {
    ...
    public ResponseDto<String> updateProfileImage(@RequestHeader(value = "Authorization") String tokenInfo, @RequestParam("file") MultipartFile profileImage) {
