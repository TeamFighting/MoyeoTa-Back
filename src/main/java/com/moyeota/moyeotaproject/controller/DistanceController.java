...
public class DistanceController {
    ...
    public ResponseDto<DurationAndFareResponseDto> getDurationAndFare(@ApiParam(value = "출발지 좌표") @RequestParam String origin, @ApiParam(value = "도착지 좌표") @RequestParam String destination) throws ParseException {
    ...
    @GetMapping("/keyword")
    public ResponseDto<AddressDto> getAddress(@ApiParam(value = "키워드") @RequestParam String query) throws ParseException {
